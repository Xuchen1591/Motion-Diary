...
namespace motion_diary_v2
{
    ...
    public sealed partial class NotePage : Page
    {
        ...
        public NotePage()
        {
            ...
            // 设置逻辑页面导航组件，使
            // 页面可一次仅显示一个窗格。
            this.navigationHelper.GoBackCommand = new motion_diary_v2.Common.RelayCommand(() => this.GoBack(), () => this.CanGoBack());
        ...
        private void motion1Taped(object sender, TappedRoutedEventArgs e)
        {
            motionName.Text = "Wonderful day , enjoy it !";
        }

        private void motion2Taped(object sender, TappedRoutedEventArgs e)
        {
            motionName.Text = "Relaxed , it'll be better !";
        }

        private void motion3Taped(object sender, TappedRoutedEventArgs e)
        {
            motionName.Text = "Usual day , move on !";
        }

        private void motion4Taped(object sender, TappedRoutedEventArgs e)
        {
            motionName.Text = "Not so good ? Cheer up !";
        }

        private void motion5Taped(object sender, TappedRoutedEventArgs e)
        {
            motionName.Text = "Bad day ! Never mind and all will be past .";
        }
